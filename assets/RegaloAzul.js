...
export default function E01({x,y,z}){
    ...
    var matCaja = new THREE.MeshLambertMaterial({ color: 0x14D4E3, side: THREE.DoubleSide }); 
    ...
    // CINTAS 
    // Material Cintas 
    var matCinta = new THREE.MeshLambertMaterial({ color: 0xFFFFFF, side: THREE.DoubleSide });
    ...
    // MOÑO
    // Material Moño
    var matMoño = new THREE.MeshLambertMaterial({ color: 0xffff00, side: THREE.DoubleSide }); 
    ...
    const REGALOAZUL = new THREE.Group();
